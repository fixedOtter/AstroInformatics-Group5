#!/bin/bash
#SBATCH --job-name=calc-rotper9                   # the name of your job
#SBATCH --output=/scratch/gj392/attempt9/output.txt	# this is the file your output and errors go
...
srun python3 /home/gj392/astroinformatics/AstroInformatics-Group5/main.py 9
